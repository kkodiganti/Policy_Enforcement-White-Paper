...
- `ACADEMIA-EDU-SUBMISSION.md` — prep sheet for uploading to academia.edu: recommended Publication Name ("SSRN Electronic Journal," once the SSRN posting is live) and a 20-item Research Interests list. That list assumes a profile spanning this author's other white papers (Human-Identification, Data-Quality-Pitfalls) too, not just this repo — flagged in the file itself as an assumption to confirm.
